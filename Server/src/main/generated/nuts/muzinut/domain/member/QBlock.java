...
public class QBlock extends EntityPathBase<Block> {
    ...
    private static final long serialVersionUID = 1332063491L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBlock block = new QBlock("block");

    public final DateTimePath<java.time.LocalDateTime> blockTime = createDateTime("blockTime", java.time.LocalDateTime.class);

    public final QUser blockUser;
    ...
    public QBlock(Class<? extends Block> type, PathMetadata metadata, PathInits inits) {
        ...
        this.blockUser = inits.isInitialized("blockUser") ? new QUser(forProperty("blockUser"), inits.get("blockUser")) : null;
