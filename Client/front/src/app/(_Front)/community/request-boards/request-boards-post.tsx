...
interface RequestBoardsPostProps {
  selected: string;
}

const RequestBoardsPost: React.FC<RequestBoardsPostProps> = ({ selected }) => {
  const posts: Post[] = [];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get("/community/request-boards");
...
export default RequestBoardsPost;
