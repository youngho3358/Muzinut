...
import RecruitBoardsPost from "./recruit-boards-post";
import Image from "next/image";
import RecruitBoardsbanner from "../../../../../public/images/eventbanner.png";
import WriteQuill from "../free-boards/writequill";

const RecruitBoardsBody: React.FC = () => {
  ...
  return (
    <RecruitBoardsContainer>
      <RecruitBoardsBanner>
        <Image src={RecruitBoardsbanner} alt="free-boards-banner"></Image>
      </RecruitBoardsBanner>
      <RecruitBoardsController>
        <RecruitBoardsOptions>
          <ul>
      ...
      <RecruitBoardsPost selected={selected} />
      {writeVisible && (
        <WriteQuill
...
export default RecruitBoardsBody;

// 이벤트 페이지 가장 바깥을 감싸는 컨테이너
const RecruitBoardsContainer = styled.div``;

// 이벤트 페이지 헤더 제목
const RecruitBoardsBanner = styled.div`
  margin-top: 24px;
...
const RecruitBoardsController = styled.div`
  padding: 10px 0 15px;
  display: flex;
...
const RecruitBoardsOptions = styled.div`
  ul {
...
// 이벤트 선택바 옵션
const RecruitBoardsOption = styled.div<{ isSelected: boolean }>`
  cursor: pointer;
