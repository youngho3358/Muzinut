...
interface NoticeWriteQuillProps {
...
const NoticeWriteQuill = forwardRef(
  (
    { onPublish, onClose, initialContent, boardId }: NoticeWriteQuillProps,
    ref
  ) => {
    ...
    const handleSubmit = async () => {
      ...
      try {
        const url = boardId
          ? `${AxiosURL}/community/free-boards/${boardId}`
          : `${AxiosURL}/community/free-boards`;
...
NoticeWriteQuill.displayName = "NoticeWriteQuill";
